...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Planet mercury = new Planet("Mercury","http://java/org/wecancodeit/mysteryeducator/images/earth.jpg","3,030 Miles", "35 million Miles", "800 Degrees F","description...",ourSS);
